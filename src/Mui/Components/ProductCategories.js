...
export default function ProductCategories() {
  return (
    <Container component="section" sx={{ mt: 8, mb: 4 }}>
      <Typography className="text-texting" variant="h4" marked="center" align="center" component="h2">
        For all ages and all desires, fulfill your dreams with Smart X BlockChain
      </Typography>
      <Box sx={{ mt: 8, display: 'flex', flexWrap: 'wrap' }}>
        {images.map((image) => (
          <ImageIconButton className='h-[350px] sm:h-[300px] rounded-2xl'
            key={image.title}
            style={{
              width: image.width,
            }}
