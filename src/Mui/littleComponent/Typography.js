...
const markClassesMapping = {
  center: {
    h1: '',
    h2: 'Smart X BlockChainTypography-markedH2Center',
    h3: 'Smart X BlockChainTypography-markedH3Center',
    h4: 'Smart X BlockChainTypography-markedH4Center',
    h5: '',
    h6: '',
  },
  left: {
    ...
    h4: '',
    h5: '',
    h6: 'Smart X BlockChainTypography-markedH6Left',
  },
  none: {
    h1: '',
    h2: '',
