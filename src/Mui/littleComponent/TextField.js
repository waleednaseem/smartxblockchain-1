...
const inputStyleMappingClasses = {
  small: 'Smart X BlockChainTextField-inputSizeSmall',
  medium: 'Smart X BlockChainTextField-inputSizeMedium',
  large: 'Smart X BlockChainTextField-inputSizeLarge',
  xlarge: 'Smart X BlockChainTextField-inputSizeXLarge',
};

const classes = {
  root: 'Smart X BlockChainTextField-root',
  input: 'Smart X BlockChainTextField-input',
  inputBorder: 'Smart X BlockChainTextField-inputBorder',
};
